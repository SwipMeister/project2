...
if (isset($_GET['del'])) {
    ...
    $db->dropArtikel($productcode);
    header("refresh:1;url=delete_product.php");

}


$result_artikel_set = $db->get_product_details(null);
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Edit or delete artikel details</b></h2>
                    </div>
                </div>
            </div>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <?php  foreach ($row as $user_data) { ?>
                           ...
                           <td><a href="edit_product.php?edit=<?php echo $row_id; ?>" class="btn btn-primary">Edit</a></td>
                           <td><a href="delete_product.php?del=<?php echo $row_id; ?>" class="btn btn-danger">Delete</a></td>
                        </tr>
                           <?php    }?>
